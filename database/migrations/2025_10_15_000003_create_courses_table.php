...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Add PostgreSQL full-text search index using GIN
        DB::statement("CREATE INDEX ftx_courses ON courses USING GIN (to_tsvector('english', coalesce(title, '') || ' ' || coalesce(short_description, '') || ' ' || coalesce(description, '')))");
    }
